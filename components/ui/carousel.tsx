...
function CarouselItem({ className, ...props }: React.ComponentProps<"div">) {
    ...
    return <div role="group" aria-roledescription="slide" data-slot="carousel-item" className={cn("", orientation === "horizontal" ? "pl-4" : "pt-4", className)} {...props} />;
}
...
function CarouselPrevious({ className, variant = "ghost", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
    ...
    return (
        <Button
            ...
            variant={variant}
            size={size}
            className={cn("absolute size-8 rounded-full", orientation === "horizontal" ? "top-1/2 -right-10 -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90", className)}
...
function CarouselNext({ className, variant = "ghost", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
    ...
    return (
        <Button
            ...
            variant={variant}
            size={size}
            className={cn("absolute size-8 rounded-full", orientation === "horizontal" ? "top-1/2 -right-20 -translate-y-1/2" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90", className)}
