import { getAllBusinesses, getTopBusinesses } from "../_actions/get-business";
    ...
    if ("error" in topBusinesses) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center">
                ...
                <p className="text-destructive mt-4 font-medium">Error: {topBusinesses.message}</p>
            </div>
        );
    }
    ...
    return (
        <main className="mx-auto min-h-screen p-8 px-4 sm:px-12">
            ...
            {businesses.length === 0 ? (
                ...
                <BusinessSearch allBusinesses={businesses} topBusinesses={topBusinesses} linkPath="/customer/businesses" placeholder="Search businesses by name or location..." />
            )}
